...
<transition name="slide-in-right" enter-active-class="animated slideInRight">
    <div v-show="show" class="request" :class="{'light-request': isDarkMode, 'dark-request':!isDarkMode}">Don't have Design+Code HQ account?
    ...
    <div class="login">
      ...
      <input type="email" placeholder="Email" :class="{'light-text': isDarkMode, 'dark-text': !isDarkMode}">
      <input type="password" placeholder="Password" :class="{'light-text': isDarkMode, 'dark-text': !isDarkMode}">
      <button>Sign In</button>
      <router-link to="/recover" :class="{'light-text': isDarkMode, 'dark-text': !isDarkMode}">Forgot your password</router-link>
